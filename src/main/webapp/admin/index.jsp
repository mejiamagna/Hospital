...
<html lang="zh-CN">
	<head>
		...
		<link rel="stylesheet" href="/Hospital/admin/css/bootstrap.css">
		<link rel="stylesheet" href="/Hospital/admin/css/font-awesome.css">
		<link rel="stylesheet" href="/Hospital/admin/css/index.css">	<!-- 修改自Bootstrap官方Demon，你可以按自己的喜好制定CSS样式 -->
		<link rel="stylesheet" href="/Hospital/admin/css/font-change.css">	<!-- 将默认字体从宋体换成微软雅黑（个人比较喜欢微软雅黑，移动端和桌面端显示效果比较接近） -->		
...
<!-- 右侧内容展示==================================================   -->   		
 				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header"><i class="fa fa-cog fa-spin"></i>&nbsp;Consola<small>&nbsp;&nbsp;&nbsp;Bienvenido al Sistema de Gestón Hospitalaria</small></h1>
