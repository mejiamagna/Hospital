...
<div class="row">
  ...
  <div class="col">
    <input type="text" class="form-control" placeholder= "0101010101" readonly="readonly" disabled>
  </div>
  <div class="col">
    <input type="text" class="form-control" placeholder= "JUAN PEREZ" readonly="readonly" disabled>
  </div>
  <div class="col">
     <input type="text" class="form-control" placeholder= "999999999" readonly="readonly" disabled>
  </div>
</div>
  ...
  <div class="mb-3">
    ...
    <select class="form-select" aria-label="Default select example">
	 ...
	 <div id="medicoHelp" class="form-text">Seleccione su Medico de preferencia</div> 
  </div>
  
  <div class="col-md-3">
    <label for="fecha" class="form-label">Fecha de la Cita</label>  
	<input type="text" id="campofecha" class="form-control">
  </div>
  ...
  <div class="col-md-2">
	...
	<input type="text" class="form-control" placeholder= "POR ATENDER" readonly="readonly" disabled>
  </div>
...
<div class="col-md-2">
    ...
    <input type="text" class="form-control" id="costo" placeholder= "Pendiente" readonly="readonly" disabled>
  </div>
